...
param <- get_param(
  raw = NULL,
  est = default_estimates("Honey Bee", "adult", "forager", "acute", "downwards")
)

snotwa <- sim(param)
test_that("NoTWA gives the same SV", {
  expect_equal(mean(snotwa), 7.6, tolerance = 1e-2)
})
...
snotwa <- sim(param)
test_that("NoTWA gives the same SV", {
  expect_equal(mean(snotwa), 5.8, tolerance = 1e-2)
})
...
param <- get_param(
  raw = NULL,
  est = default_estimates("Honey Bee", "adult", "nurse", NULL, "downwards")
)

snotwa <- sim(param)
test_that("NoTWA gives the same SV", {
  expect_equal(mean(snotwa), 3.8, tolerance = 1e-2)
})
...
param <- get_param(
  raw = NULL,
  est = default_estimates("Honey Bee", "larvae", NULL, NULL, "downwards")
)

snotwa <- sim(param)
test_that("NoTWA gives the same SV", {
  expect_equal(mean(snotwa), 4.4, tolerance = 1e-2)
})
...
param <- get_param(
  raw = NULL,
  est = default_estimates("Bumble Bee", "adult", NULL, "acute", "downwards")
)

snotwa <- sim(param)
test_that("NoTWA gives the same SV", {
  expect_equal(mean(snotwa), 11.2, tolerance = 1e-2)
})
...
param <- get_param(
  raw = NULL,
  est = default_estimates("Bumble Bee", "adult", NULL, "chronic", "downwards")
)

snotwa <- sim(param)
test_that("NoTWA gives the same SV", {
  expect_equal(mean(snotwa), 9.9, tolerance = 1e-2)
})
...
param <- get_param(
  raw = NULL,
  est = default_estimates("Bumble Bee", "larvae", NULL, NULL, "downwards")
)
...
param <- get_param(
  raw = NULL,
  est = default_estimates("Solitary Bee", "adult", NULL, NULL, "downwards")
)

snotwa <- sim(param)
test_that("NoTWA gives the same SV", {
  expect_equal(mean(snotwa), 5.7, tolerance = 1e-2)
})
...
param <- get_param(
  raw = NULL,
  est = default_estimates("Solitary Bee", "larvae", NULL, NULL, "downwards")
)

snotwa <- sim(param)
test_that("NoTWA gives the same SV", {
  expect_equal(mean(snotwa), 33.6, tolerance = 1e-2)
})
...
snotwa <- sim(param)
test_that("NoTWA gives the same SV", {
  expect_equal(mean(snotwa), 10.6, tolerance = 1e-2)
})
...
snotwa <- sim(param)
test_that("NoTWA gives the same SV", {
  expect_equal(mean(snotwa), 8.2, tolerance = 1e-2)
})
...
param <- get_param(
  raw = NULL,
  est = default_estimates("Honey Bee", "adult", "nurse", NULL, "up/sidewards")
)

snotwa <- sim(param)
test_that("NoTWA gives the same SV", {
  expect_equal(mean(snotwa), 4.3, tolerance = 1e-2)
})
...
param <- get_param(
  raw = NULL,
  est = default_estimates("Honey Bee", "larvae", NULL, NULL, "up/sidewards")
)

snotwa <- sim(param)
test_that("NoTWA gives the same SV", {
  expect_equal(mean(snotwa), 6.1, tolerance = 1e-2)
})
...
param <- get_param(
  raw = NULL,
  est = default_estimates("Bumble Bee", "adult", NULL, "acute", "up/sidewards")
)

snotwa <- sim(param)
test_that("NoTWA gives the same SV", {
  expect_equal(mean(snotwa), 13.3, tolerance = 1e-2)
})
...
snotwa <- sim(param)
test_that("NoTWA gives the same SV", {
  expect_equal(mean(snotwa), 11.4, tolerance = 1e-2)
})
...
param <- get_param(
  raw = NULL,
  est = default_estimates("Bumble Bee", "larvae", NULL, NULL, "up/sidewards")
)
...
param <- get_param(
  raw = NULL,
  est = default_estimates("Solitary Bee", "adult", NULL, NULL, "up/sidewards")
)

snotwa <- sim(param)
test_that("NoTWA gives the same SV", {
  expect_equal(mean(snotwa), 7.3, tolerance = 1e-2)
})
...
param <- get_param(
  raw = NULL,
  est = default_estimates("Solitary Bee", "larvae", NULL, NULL, "up/sidewards")
)

snotwa <- sim(param)
test_that("NoTWA gives the same SV", {
  expect_equal(mean(snotwa), 9.6, tolerance = 1e-2)
})
...
param <- get_param(raw = NULL, est = est)
...
snotwa <- sim(param)
test_that("NoTWA gives the same SV", {
  expect_equal(mean(snotwa), 2.9, tolerance = 1e-2)
})
...
snotwa <- sim(param)
test_that("NoTWA gives the same SV", {
  expect_equal(mean(snotwa), 2.1, tolerance = 1e-2)
})
...
snotwa <- sim(param)
test_that("NoTWA gives the same SV", {
  expect_equal(mean(snotwa), 6.5, tolerance = 1e-2)
})
...
snotwa <- sim(param)
test_that("NoTWA gives the same SV", {
  expect_equal(mean(snotwa), 5.9, tolerance = 1e-2)
})
...
snotwa <- sim(param)
test_that("NoTWA gives the same SV", {
  expect_equal(mean(snotwa), 2.6, tolerance = 1e-2)
})
...
snotwa <- sim(param)
test_that("NoTWA gives the same SV", {
  expect_equal(mean(snotwa), 30.8, tolerance = 1e-2)
})
...
snotwa <- sim(param)
test_that("NoTWA gives the same SV", {
  expect_equal(mean(snotwa), 0.35, tolerance = 1e-2)
})
