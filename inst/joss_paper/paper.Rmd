...
```{r screenshot, echo = FALSE, out.width="100%", fig.cap="Screenshot of shinyshval. On right parameters can be changed. In the middle default parameters be selected. The right side shows the computed shval."}
